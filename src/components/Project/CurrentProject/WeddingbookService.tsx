...
export default function WeddingbookService() {
  return (
    <CurrentProjectDetail
      ...
      images={[WeddingbookInvitationImage, WeddingbookWeddinghallImage, WeddingbookHomeImage, WeddingbookHonsuImage]}
      highlights={[
        {
          title: 'React 기반 앱 WebView의 주요 기능을 Next.js 웹으로 점진 마이그레이션해, 이중으로 개발·운영되던 프론트엔드 구조를 단일 프로젝트로 통합',
          details: [],
        },
        {
          title: 'TanStack Query 도입으로 목록 조회·탐색 경험 개선',
          details: [
