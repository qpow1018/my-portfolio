      ...
      <div className={styles["case-detail-list"]}>
        ...
        <CaseDetailItem title="Icon">
          <p>
            ...
            구조였고, 같은 종류의 아이콘도 크기별 파일이 따로 존재했습니다. 일부
            사용처에서는 사용할 SVG가 위치한 경로까지 직접 지정해야 했습니다.
          </p>
          <p>
            아이콘의 종류와 화면에 표시할 크기를 분리해, SVG는 name으로 선택하고
            size는 표시 크기만 담당하도록 변경했습니다. 색상도 별도로 지정할 수
            있도록 정리하고, 기존 사용처를 새로운 구조로 전환한 뒤 크기별 SVG
            디렉터리와 기존 Icon 구현을 제거했습니다.
          </p>
        </CaseDetailItem>
      </div>
    </CaseBox>
