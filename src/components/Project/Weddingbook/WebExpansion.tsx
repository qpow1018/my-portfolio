      ...
      <div className={styles["case-list"]}>
        ...
        >
          <p>
            ...
            WebView로 이동하는 URL은 기존 React 프로젝트의 도메인을 기준으로
            하고 있었습니다.
          </p>
          <p>
            서비스를 Next.js 웹으로 확장하면서 이러한 주소 형식을 그대로 사용할
            수 없었습니다. 앱 Scheme은 일반 웹에서 같은 방식으로 처리할 수
            없었고, 기존 도메인이 포함된 URL은 새로운 웹이 아닌 이전 React
            프로젝트로 이동하는 문제가 있었습니다.
          </p>
          <div className={styles["divider"]} />
          <p>
            기존 주소가 서비스 전반에 광범위하게 사용되고 있었고, 사용처가
            한곳에서 관리되는 구조가 아니어서 모든 주소를 파악하고 각각 수정하기
            어려웠습니다. 따라서 기존 주소를 하나씩 변경하기보다, 주소 형식에
            따라 변환해 웹에서도 사용할 수 있도록 처리하는 방식을 선택했습니다.
          </p>
          <p>
            앱 Scheme은 대응하는 웹 경로로 변환하고, 기존 React 프로젝트를
            가리키는 URL은 현재 웹에서 사용할 수 있는 경로로 변환했습니다.
          </p>
        </CaseBox>
        ...
        >
          ...
          <p>
            ...
            초기화되지 않도록, 스크롤 위치는 브라우저의 기본 복원 동작을
            활용하고 서버 데이터는 TanStack Query의 캐시를 활용했으며, 필요한
            상태는 URL에 유지했습니다.
          </p>
        </CaseBox>
        ...
        >
          <p>
            ...
            로그인 확인이 없더라도 실제 사용 과정에서 문제가 잘 드러나지
            않았습니다.
          </p>
          <p>
          ...
          <p>
            기존에는 필요한 페이지에서 각각 로그인 여부를 확인하고 있어 같은
            처리가 반복되었고, 일부 페이지에서는 이 처리가 누락되는 경우도
            있었습니다.
          </p>
          <div className={styles["divider"]} />
          <p>
