...
function Case1() {
  return (
    ...
    >
      ...
      <p>
        이 링크들은 어드민에서 설정되는 데이터 등 여러 곳에 누적되어 있어,
        전체를 파악해 일괄 수정하기 어려운 상태였습니다. 그래서 기존 링크를 일괄
        변경하는 대신, 기존 공통 라우터의 URL 정규화 로직을 확장해
        프론트엔드에서 호환하도록 했습니다.
      </p>
      <div className={styles["divider"]} />
      <p>
        웹에서 대응 가능한 Scheme과 WebView 링크는 현재 웹 경로로 변환했습니다.
        웹에서 지원하지 않는 App Scheme은 앱에서는 기존 Scheme 동작을 유지하고,
        웹에서는 앱 설치로 유도하도록 분기했습니다.
      </p>
